...
We also explored mode of duplication od chemosensory genes using R package doubletrouble https://github.com/almeidasilvaf/doubletrouble
...
The genes coordinates were enlarged (2 kb and 10 kb) using bedtools slop
